...
<tr><td><br>
 ...
 <td width="90" rowspan="3" align="center"><img src="<?php echo base_url().'assets/logo1.png'?>" style="width:90px;height:90px"></td>
   	...
   	<table align="center" width="97%" border="0">
		...
		<tr>
			<td colspan="5" align="center"><u><h3>LAPORAN PERBULAN</h3></u></td>
		</tr>
		<!--
		<tr>
...
<td> <b> Bulan  : 
	  ...
	  <?php if ($b == null){echo '<p>Tidak Ada Data</p>';}else{?>
								   <!-- <?php echo $b['tanggalberangkat1']?> -->
								   <?php echo "Bulan: ".$newDate = date("m-Y", strtotime($bulan->tanggal)); ?>
                                <?php }?>
                                </b> </td>
				 </tr>
		...
		<table  align="center" width="1200px" style="border-collapse:collapse" border="1">
			<thead>
				<tr>
					...
					<th bgcolor="#CCCCCC" width="30">kodebayar</th>
					
					<th bgcolor="#CCCCCC"width="50" >kode pelanggan</th>
					<th bgcolor="#CCCCCC"width="50" >Nama sopir</th>
					<th bgcolor="#CCCCCC"width="15">Nomor mobil</th>
					
					<th bgcolor="#CCCCCC"width="30">Tanggal Berangkat</th>
					<th bgcolor="#CCCCCC" width="30">Harga</th>
					<th bgcolor="#CCCCCC" width="30">Jumlah Bayar</th>
					<th bgcolor="#CCCCCC" width="30">Kembalian</th>
			...
			<tbody>
				<tr>
				  ...
				  <td>&nbsp;<?php echo $a['kodebayar']; ?></b></td>

 	 
      <td>&nbsp;<?php echo $a['kodepelanggan']; ?></td>
      <td>&nbsp;<?php echo $a['namasopir']; ?></td>
      <td>&nbsp;<?php echo $a['nomormobil']; ?></td>
      
      <td>&nbsp;<?php echo $a['tanggalberangkat']; ?></td>
      <td>&nbsp;<?php echo $a['totalbayar']; ?></td>
        <td>&nbsp;<?php echo $a['jumlahbayar']; ?></td>
      <td>&nbsp;<?php echo $a['kembalian']; ?></td>
