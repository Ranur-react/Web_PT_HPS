...
<div class="modal-footer"> 
      ...
      <form class="form-horizontal" name="formD" method="post" action="<?php echo base_url().'index.php/Pengiriman_controller/tambah_pengiriman_user'?>">
                ...
                <div class="form-group row">
                    ...
                    <div class="col-sm-10">
                      <input class="form-control" type="text" name="nama_pengirim" value="<?php echo $this->session->userdata('ses_nama');?>" placholder/>
                    </div>
                  </div>
