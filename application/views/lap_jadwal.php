...
<table align="center" width="696" border="0" cellpadding="0" cellspacing="0">
   	...
   	<table align="center" width="97%" border="0">
		...
		<tr>
			<td colspan="5" align="center"><h2>LAPORAN DATA JADWAL KEBERANGKATAN BUS</h2></td>
		</tr>
		<!--
		<tr>
		...
		<table  align="center" width="1200px" style="border-collapse:collapse" border="1">
			<thead>
				<tr>
					<th bgcolor="#CCCCCC"  align="center" wkodejadwalth="10">No</th>
					<th bgcolor="#CCCCCC" wkodejadwalth="30">ID JADWAL</th>
					<th bgcolor="#CCCCCC" wkodejadwalth="30">JAM BERANGKAT</th>
					<th bgcolor="#CCCCCC"wkodejadwalth="50" >TUJUAN</th>
					<th bgcolor="#CCCCCC"wkodejadwalth="50" >ID BUS</th>
					<th bgcolor="#CCCCCC"wkodejadwalth="50" >NAMA SOPIR</th>
			...
			<tbody>
				<tr>
				 ...
				 <td>&nbsp;<?php echo $a['id_jadwal']; ?></b></td>
			
 	 
      <td>&nbsp;<?php echo $a['jam']; ?></td>

       <td>&nbsp;<?php echo $a['tujuan']; ?></td>
        <td>&nbsp;<?php echo $a['id_bus']; ?></td>
