...
<tr><td><br>
 ...
 <td width="90" rowspan="3" align="center"><img src="<?php echo base_url().'assets/logo1.png'?>" style="width:90px;height:90px"></td>
   	...
   	<table align="center" width="97%" border="0">
		...
		<tr>
			<td colspan="5" align="center"><u><h3>LAPORAN DATA KARYAWAN</h3></u></td>
		</tr>
		<!--
		<tr>
		...
		<table  align="center" width="1200px" style="border-collapse:collapse" border="1">
			<thead>
				<tr>
					...
					<th bgcolor="#CCCCCC" width="30">ID KARYAWAN</th>
					
					<th bgcolor="#CCCCCC"width="50" >NAMA</th>
					<th bgcolor="#CCCCCC"width="50" >EMAIL</th>
				
					
					<th bgcolor="#CCCCCC"width="30">PHOTO</th>
					<th bgcolor="#CCCCCC" width="30">LEVEL</th>
      ...
      <td>&nbsp;<img width="100" height="70" src="<?php echo base_url();?>images/<?php echo $a['image']?>" class="img-thumbnail" alt="Foto"></td>
      	<td>
				<?php
					if( $a['level']=='1')
						{echo"Administrator";}
