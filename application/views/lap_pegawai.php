...
<tr><td><br>
	...
	<table align="center" width="696" border="0" cellpadding="0" cellspacing="0">
   	...
   	<table align="center" width="97%" border="0">
		...
		<tr>
			<td colspan="5" align="center"><h2>LAPORAN PEGAWAI</h2></td>
		</tr>
		<!--
		<tr>
		...
		<table  align="center" width="1200px" style="border-collapse:collapse" border="1">
			<thead>
				<tr>
					...
					<th bgcolor="#CCCCCC" wight="30">FOTO</th>
					<th bgcolor="#CCCCCC"wight="50" >NAMA </th>
					<th bgcolor="#CCCCCC"wight="50" >USERNAME</th>
					<th bgcolor="#CCCCCC"wight="30">EMAIL</th>
					<th bgcolor="#CCCCCC"wight="30">LEVEL</th>
      ...
      <td>&nbsp;<?php echo $a['nama']; ?></td>
       <td>&nbsp;<?php echo $a['alamat']; ?></td>
		...
		<td>
                ...
                <td class="text-center"><img width="100" height="70" src="<?php echo base_url(); ?>images/<?php echo $a['image'] ?>" class="img-thumbnail" alt="Foto">  
                </td>
