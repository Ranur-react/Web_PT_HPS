...
<section class="content">
            ...
            <div class="col-lg-12">
                <div class="card card-info">
                    <div class="card-header">
                        <marquee behavior="" direction=""> <a class="navbar-brand" href=""><b>Silahkan Ingat Kode Tiket Mu dan Lakukan Pembayaran Lansung ke Loket </b></a> </marquee> 
                        <h3 class="card-title">
                            Input Data Pribadi
                        </h3>
                    </div>
 ...
 $('#modal_jadwal_kategori').modal('hide');"></button><i class="glyphicon glyphicon-ok-sign" aria- hidden="true"></i>PILIH</span>
                                                    </td>
                                                </tr>
                                            <?php endforeach; ?>
                                        </tbody>
 ...
 $('#modal_jadwal').modal('hide');"></button><i class="glyphicon glyphicon-ok-sign" aria- hidden="true"></i>PILIH</span>
                                                    </td>
                                                </tr>
                                            <?php endforeach; ?>
                                        </tbody>
 ...
 $('#modal_kursi').modal('hide');"></button><i class="glyphicon glyphicon-ok-sign" aria- hidden="true"></i>PILIH</span>
               ...
               ";
                            ...
                            <div class="card-header">
                                ...
                                // var_dump();
                                ?>
                                <div class="alert alert-success <?= $statusNOtif ?'':'hide' ?>" >
                                    ...
                                    <table>
                                        <tr>
                                            ...
                                            <td>
                                                ...
                                                <a href="javascript:void(0)" onclick="cari_kursi()" class="btn btn-primary"><i class="fa fa-search"></i></a>
                                            </td>
                                        </tr>
...
glyphicon-floppy-saved"></span> Simpan
</button>
