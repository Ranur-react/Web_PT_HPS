...
<div class="modal-footer"> 
      ...
      <?php 
                    ...
                    foreach ($tampil_pengirim->result_array() as $a):
                        $no++;
      ...
      <form class="form-horizontal" name="formD" method="post" action="<?php echo base_url().'index.php/Pengiriman_controller/update_pengiriman'?>">
                ...
                <div class="form-group row">
                    ...
                    <div class="col-sm-10">
                      ...
                      <input class="form-control" type="hidden" name="id_pengiriman" value="<?php echo $a['id_pengiriman']?>" id="" placholder/>
                          </td>
                          <td>
                ...
                <div class="form-group row">
                    ...
                    <div class="col-sm-10">
                      <input class="form-control" type="text" name="nama_pengirim"value="<?php echo $a['nama_pengirim']?>"  placholder/>
                    </div>
                  </div>
                ...
                <div class="form-group row">
                    ...
                    <div class="col-sm-10">
                      <input class="form-control" type="text" name="nama_penerima" id="nama_penerima"value="<?php echo $a['nama_penerima']?>" placholder/>
                    </div>
                  </div>
                ...
                <div class="form-group row">
                    ...
                    <div class="col-sm-10">
                      <input class="form-control" type="text" name="alamat" id="alamat"value="<?php echo $a['alamat']?>" placholder/>
                    </div>
                  </div>
                  ...
                  <div class="form-group row">
                    ...
                    <div class="col-sm-10">
                      <input class="form-control" type="text" name="nohp" id="nohp"value="<?php echo $a['nohp']?>" placholder/>
                    </div>
                  </div>
                  ...
                  <div class="form-group row">
                    ...
                    <div class="col-sm-10">
                      <input class="form-control" type="date" name="tanggal" id="tanggal"value="<?php echo $a['tanggal']?>" placholder/>
                    </div>
                  </div>
...
function stopCalc(){clearInterval(interval)}
                  ...
                  <div class="form-group row">
                    ...
                    <div class="col-sm-10">
                    <input name="totalbayar"value="<?php echo $a['biaya']?>"   id="harga" onFocus="startCalc();"  onBlur="stopCalc();" style="width:335px;"class="form-control" type="number" required >
                  ...
                  <div class="form-group row">
                    ...
                    <input name="jumlah_bayar" id="jumlah_bayar"value="<?php echo $a['bayar']?>" onFocus="startCalc();" onBlur="stopCalc();" onBlur="stopCalc();"style="width:335px;" class="form-control" type="number" required >
                  ...
                  <div class="form-group row">
                    ...
                    <div class="col-sm-10">
                    <input name="kembalian" onkeyup="convertToRupiah(this);" value="<?php echo $a['kembalian']?>" id="kembalian" style="width:335px;" class="form-control" type="text" required >
