...
<table align="center" width="696" border="0" cellpadding="0" cellspacing="0">
   	...
   	<table align="center" width="97%" border="0">
		...
		<tr>
			<td colspan="5" align="center"><h2>LAPORAN DATA KATEGORI PENUMPANG</h2></td>
		</tr>
		<!--
		<tr>
		...
		<table  align="center" width="1200px" style="border-collapse:collapse" border="1">
			<thead>
				<tr>
					<th bgcolor="#CCCCCC"  align="center" wkodekategorith="10">No</th>
					<th bgcolor="#CCCCCC" wkodekategorith="30">ID KATEGORI</th>
					<th bgcolor="#CCCCCC" wkodekategorith="30">NAMA KATEGORI</th>
					<th bgcolor="#CCCCCC"wkodekategorith="50" >HARGA</th>
			...
			<tbody>
				<tr>
				 ...
				 <td>&nbsp;<?php echo $a['id_kategori']; ?></b></td>
