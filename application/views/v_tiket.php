<div align="right">
 ...
 <a href="<?php echo base_url('Tiket_controller/form_tiket')?>" class="btn btn-sm btn-primary" >Tambah Tiket</a></div>
...
';
 ...
 echo '
    ...
    ?>
                        ...
                        <a class="btn btn-success btn-xs btn-circle" href="#modalEditPelanggan<?php echo $kode_tiket?>"data-toggle="modal"  title="Edit"><span class="fa fa-edit"></span> </a>
          ...
          <div id="modalEditPelanggan<?php echo $kode_tiket?>" class="modal fade" tabindex="-1" role="dialog" aria-labelledby="largeModal" aria-hidden="true">
                    <div class="modal-dialog">
                    <div class="modal-content">
                    <div class="modal-header">
                        <h3 class="modal-title" id="myModalLabel"> Update Keterangan</h3>
                    </div>
                    <form class="form-horizontal" method="post" action="<?php echo base_url().'index.php/Tiket_controller/update_status'?>">
    ...
    document.getElementById('jam').value = A[id_jadwal].jam; 
     document.getElementById('tujuan').value = A[id_jadwal].tujuan; 
      ...
      document.getElementById('nama_sopir').value = A[id_jadwal].nama_sopir; 
                        ...
                        <div class="form-group">
                        <label class="control-label col-xs-3" >Jumlah tiket</label>
                        <div class="col-xs-9">
                        <div class="form-line">
                            <textarea name="keterangan" id="" class="form-control" cols="30" rows="3"></textarea>
                        </div>
