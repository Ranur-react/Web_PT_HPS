<!-- <h4><font f="Verdana">Form kategori Keluarga </font></h4><hr/>
 ...
 -->
<script src="<?php echo base_url() . 'asset/sweetalert2/sweetalert.min.js' ?>"></script>
<section class="content">
 ...
 $('#modal_jadwal_kategori').modal('hide');"></button><i class="glyphicon glyphicon-ok-sign" aria-
                                                            hidden="true"></i>PILIH</span>
                                                </td>
                                            </tr>
                                            <?php endforeach; ?>
                                        </tbody>
 ...
 $('#modal_jadwal').modal('hide');"></button><i class="glyphicon glyphicon-ok-sign" aria-
                                                            hidden="true"></i>PILIH</span>
                                                </td>
                                            </tr>
                                            <?php endforeach; ?>
                    ...
                    <div id="modal_kursi1" class="modal modal fade modal-xl" role="dialog">
                        <div class="modal-dialog modal-lg">
                            <!-- konten modal-->
                            <div class="modal-content modal-xl">
                                <!-- heading modal -->
 ...
 $('#modal_kursi').modal('hide');"></button><i class="glyphicon glyphicon-ok-sign" aria- hidden="true"></i>PILIH</span>
                                                </td>
                                            </tr>
                                            <?php endforeach; ?>
                                        </tbody>
                    ...
                    <form class="form-horizontal" name="formD" method="post"
                        action="<?php echo base_url() . 'index.php/Tiket_controller/tambah' ?>">
                        ...
                        <div class="card-body">
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-sm-10">
                                    <input class="form-control" type="text" name="nama_penumpang" placholder />
                                </div>
                            </div>
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-sm-10">
                                    <label>
                                        <input type='radio' name='jenis_kelamin' id='modallevel' value='Laki-laki'
                                            class='ace' checked />
                                        <span class='lbl'> Laki-Laki</span>
                                    </label>&nbsp;
                                    <label>
                                        <input type='radio' name='jenis_kelamin' id='modallevel' class='ace'
                                            value='Perempuan' />
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-sm-10">
                                    <table>
                                        <tr>
                                            <td width="1000">
                                                <input class="form-control" type="text" name="kategori" id="id_kategori"
                                                    placholder />
                                            </td>
                                            <td>
                                                <a class="btn  btn-primary btnTambah" data-toggle="modal"
                                                    data-target="#modal_jadwal_kategori"><i
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-sm-10">
                                    <table>
                                        <tr>
                                            <td width="1000">
                                                <input class="form-control" type="text" name="id_jadwal" id="id_jadwal"
                                                    placholder />
                                            </td>
                                            <td>
                                                <a class="btn  btn-primary btnTambah" data-toggle="modal"
                                                    data-target="#modal_jadwal"><i class="fa fa-search"></i></a>
                                            </td>
                                        </tr>
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-sm-10">
                                    <input class="form-control" type="text" name="nama_sopir" id="nama_sopir"
                                        placholder />
                                </div>
                            </div>
                            <div class="form-group row">
                                ...
                                <div class="col-sm-10">
                                    <table>
                                        <tr>
                                            <td width="1000">
                                                <input class="form-control" type="text" name="kursi" id="kursi"
                                                    placholder />
                                            </td>
                                            <td>
                                                <!-- <button type="button" class="btn  btn-primary cari_kursi"><i class="fa fa-search"></i></button> -->
                                                <a href="javascript:void(0)" onclick="cari_kursi()"
                            ...
                            <div class="form-group row">
                                <label for="inputPassword3" class="col-sm-2 col-form-label">Keterangan Barang
                                    Bawaan</label>
                                <div class="col-sm-10">
                                    <textarea name="keterangan" id="" class="form-control" cols="30"
                                        rows="3"></textarea>
                                </div>
                            </div>
                            <script>
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-sm-10">
                                    <table>
                                        <tr>
                                            <td width="1000">
                                                <input name="harga" onkeyup="convertToRupiah(this);" id="harga"
                                                    onFocus="startCalc();" onBlur="stopCalc();" style="width:335px;"
                                            ...
                                            <td>
                                                ...
                                                <input type="submit" class="btn  btn-primary btnTambah fa fa-plus"
                                                    name="ok" value="ADD">
                                            </td>
                                        </tr>
                                    </table>
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            ...
                                            <td style="text-align:center;">
                                                ...
                                                <a class="btn btn-xs btn-danger"
                                                    href="<?php echo site_url('Tiket_controller/hapus_tiket_temp/' . $a['kode_tiket']) ?>"
                                                    data-toggle="modal" title="Hapus"><span class="fa fa-close"></span>
                                                    Hapus</a>
                                            </td>
                                        </tr>
                                        ...
                                        <tr>
                                            ...
                                            <td style="text-align:right;">
                                                <b><?php echo 'Rp ' . number_format($jumlah); ?></b>
                                            </td>
                                        </tr>
                                    </tbody>
                                </table>
...
function cari_kursi() {
    ...
    $.ajax({
        url: "<?= site_url('tiket_controller/cari_kursi') ?>",
        type: "GET",
        data: {
            tanggal: tanggal,
            id_jadwal: id_jadwal,
...
function pilih(id_kursi) {
    var tanggal = $('#tanggal').val();
    var id_jadwal = $('#id_jadwal').val();
    var id_bus = $('#id_bus').val();
    $.ajax({
        url: "<?= base_url('tiket_controller/pilih_kursi') ?>",
        type: "GET",
        dataType: 'json',
