...
<table align="center" width="696" border="0" cellpadding="0" cellspacing="0">
   	...
   	<table align="center" width="97%" border="0">
		...
		<tr>
			<td colspan="5" align="center"><h2>LAPORAN DATA MOBIL</h2></td>
		</tr>
		<!--
		<tr>
		...
		<table  align="center" width="1200px" style="border-collapse:collapse" border="1">
			<thead>
				<tr>
					...
					<th bgcolor="#CCCCCC" wkodemobilth="30">KODE MOBIL</th>
					<th bgcolor="#CCCCCC" wkodemobilth="30">NAMA MOBIL</th>
					<th bgcolor="#CCCCCC"wkodemobilth="50" >NOMOR MOBIL</th>
					<th bgcolor="#CCCCCC"wkodemobilth="50" >MEREK</th>
			...
			<tbody>
				<tr>
				 ...
				 <td>&nbsp;<?php echo $a['id_bus']; ?></b></td>

 	 
      <td>&nbsp;<?php echo $a['nama']; ?></td>

       <td>&nbsp;<?php echo $a['nomor_bus']; ?></td>
