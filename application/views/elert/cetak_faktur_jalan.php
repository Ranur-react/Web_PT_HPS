        ...
        <div class="row">
            <div class="col-lg-12">
                <div class="alert alert-success">
                    ...
                    <input type="hidden"  value="<?php echo $b['kode'];?>" name="">
           
                    <a class="btn btn-info" href="<?php echo base_url().'index.php/Surat_jalan_controller/faktur/'.$b['kode'];?>" target="_blank"><span class="fa fa-print"></span>Cetak</a>
