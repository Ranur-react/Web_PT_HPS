...
<head>
    ...
    <title>Transaksi pengiriman</title>
...
?>-->
        ...
        <div class="row">
            <div class="col-lg-12">
                <div class="alert alert-success">
                    ...
                    <a class="btn btn-default" href="<?php echo base_url().'index.php/Pengiriman_controller/v_pengiriman_user'?>"><span class="fa fa-backward"></span>Kembali</a>

                    <?php foreach ($tampil->result_array()as $a){
                  
                     $iid_pengirimand=$b['id_pengiriman'];
                    ?>
                 
                    <input type="hidden"  value="<?php echo $a['id_pengiriman'];?>" name="">
                <?php }?>
                    <a class="btn btn-info" href="<?php echo base_url().'index.php/Pengiriman_controller/faktur/'.$a['id_pengiriman'];?>" target="_blank"><span class="fa fa-print"></span>Cetak</a>
        ...
        <footer>
            <div class="row">
                <div class="col-lg-12">
                    <p style="text-align:center;">Copyright &copy; <?php echo date('Y');?> by nuri</p>
                </div>
            </div>
            <!-- /.row -->
        </footer>
