...
class Tiket_model extends CI_Model
{
	...
	{
		$hsl = $this->db->query("SELECT kode_tiket,tujuan,tb_tiket_temp1.kode_tiket, `tb_kursi_penumpang`.kursi, tb_kategori.nama, tb_tiket_temp1.harga FROM `tb_tiket_temp1`,`tb_kategori`,`tb_kursi_penumpang`,tb_jadwal WHERE tb_tiket_temp1.`id_kursi`=`tb_kursi_penumpang`.id_kursi AND tb_tiket_temp1.`kategori`=`tb_kategori`.`id_kategori` AND tb_jadwal.id_jadwal=tb_tiket_temp1.id_jadwal");
		return $hsl;
	}
